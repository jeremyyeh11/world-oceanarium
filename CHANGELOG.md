...
- Pushes the Mola target/debug volume to an intentionally extreme negative-Z range (`[-110, -30]`) and fixes swim-profile resolution so custom species bounds actually reach runtime movement/path generation.
