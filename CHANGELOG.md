...
- Pulls the Mola back from the diagnostic extreme to a nearer-but-still-deeper negative-Z target/debug range (`[-45, -14]`) after confirming the runtime bounds path works.
