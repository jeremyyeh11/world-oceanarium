...
The current clean release is `v0.13.0`; `v0.13.0-dev_4` is the in-review cinematic-camera build pending final retarget after rebase. The ocean sunlight zone contains two deliberately curated tanks:
...
- species-locked documentary shot direction entered from a followed fish, built from that species' live individuals/pairs/schools with validity-gated jump cuts and no hardcoded cast
