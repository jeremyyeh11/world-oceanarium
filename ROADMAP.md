...
- Implementation target: `v0.8.15-dev_15` adds the latest bend multiplier plus schooling path-continuation/pitch-smoothing fixes after `dev_14` made visible turn-intent curl.
