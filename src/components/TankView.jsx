...
const DEFAULT_FOLLOW_DISTANCE = 4.4
const MIN_FOLLOW_DISTANCE = 1.75
const MOLA_MIN_FOLLOW_BODY_LENGTHS = 1.28
const MAX_FOLLOW_DISTANCE = 24
const LARGE_CREATURE_FOLLOW_BODY_LENGTHS = 2.45
const LARGE_CREATURE_MAX_FOLLOW_BODY_LENGTHS = 4.8
