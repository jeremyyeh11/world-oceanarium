...
export const SPECIES = [
  ...
  },
  {
    ...
    swim: {
      ...
      bodyLengthWU: 16,
      visualTimeScale: 0.48,
      idleBLPerSec: [0.20, 0.34],
      idleDriftBLPerSec: [0.045, 0.085],
      snapBLPerSec: [0.38, 0.58],
      burstBLPerSec: [0.82, 1.18],
      burstInterval: [12.0, 20.0],
      driftInterval: [14.0, 24.0],
      driftDuration: [3.5, 6.0],
      burstActionDuration: 2.4,
      turnActionDuration: 2.0,
      turnTriggerThreshold: 0.018,
      erraticness: 0.035,
      turnRadius: 0.96,
      speedMultiplier: 1.0,
      movementBoundsScale: 1.62,
      soloSteeringTurnRateDegrees: 10,
      soloTargetVerticalBodyLengths: 0.36,
      boundsUseSpeciesSize: false,
      boundsYMin: -8,
      boundsZMin: -36,
      boundsZMax: 4,
