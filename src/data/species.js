...
export const SPECIES = [
  ...
  },
  {
    ...
    atlasDetails: {
      ...
      lifeSpan: 'Usually short-lived; up to about 4 years reported.',
      maturityAge: 'Months, not years.',
      social: {
        schoolSize: '2–50',
        groupingBehaviour: 'Fast pelagic cruisers that often travel in pairs or loose schools, especially around floating objects and feeding opportunities.',
        reproduction: 'Broadcast spawning in warm surface waters, with repeated spawning during the season and no parental care.',
      },
      averages: {
        maleSizeMeters: 1.0,
        femaleSizeMeters: 0.9,
        maleWeightKg: 9,
        femaleWeightKg: 7,
