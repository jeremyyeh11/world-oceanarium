...
export const SPECIES = [
  ...
  },
  {
    id: 'mola-alexandrini',
    legacyIds: ['mola-mola'],
    legacyNames: ['Ocean Sunfish', 'Giant Sunfish'],
    name: 'Bumphead Sunfish',
    ...
    description: 'The bumphead sunfish rows its tall dorsal and anal fins together, usually traveling alone through open water after maturity. Juveniles may loosely school for protection before dispersing; adults can briefly aggregate to broadcast spawn, then return to solitary cruising, deep soft-bodied prey hunts, and sideways surface basking.',
