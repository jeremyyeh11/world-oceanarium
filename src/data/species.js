...
export const SPECIES = [
  ...
  },
  {
    ...
    swim: {
      ...
      bodyLengthWU: 7.2,
      // Fast adult pelagic feel: solo-agent navigation like Mola, but much quicker, cleaner, and more dart-capable.
      visualTimeScale: 0.42,
      idleBLPerSec: [0.24, 0.42],
      idleDriftBLPerSec: [0.04, 0.10],
      snapBLPerSec: [0.38, 0.62],
      burstBLPerSec: [1.05, 1.48],
      burstInterval: [7.0, 12.0],
      driftInterval: [10.0, 18.0],
      driftDuration: [3.0, 5.5],
      burstActionDuration: 2.1,
      turnActionDuration: 1.35,
      turnTriggerThreshold: 0.018,
      erraticness: 0.06,
      turnRadius: 1.65,
      soloSteeringTurnRateDegrees: 44,
      soloTargetVerticalBodyLengths: 0.12,
