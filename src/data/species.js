...
export const SPECIES = [
  ...
  },
  {
    ...
    swim: {
      ...
      bodyLengthWU: 7.2,
      // Adult Mahi-mahi are rendered as loose body-length-scaled pairs,
      // capped at two fish, not a biological school.
      schoolMaxSize: 2,
      schoolSpacingScale: 5.2,
      schoolPathMinFirstTurnBodyLengths: 2.2,
      schoolPathContinuationBodyLengths: 3.25,
      schoolMaxAvoidanceAngleDegrees: 16,
      schoolDirectionResponse: 2.8,
      ...
      erraticness: 0.08,
      turnRadius: 1.05,
      turnRadiusLargeBodyBonus: 0.12,
      speedMultiplier: 1.0,
      movementBoundsScale: 1.38,
      boundsYMin: -6.5,
      boundsZMin: -28,
      boundsZMax: 5,
    },
  ...
  },
  {
    ...
    swim: {
      ...
      erraticness: 0.055,
      turnRadius: 1.0,
      turnRadiusLargeBodyBonus: 0.25,
      speedMultiplier: 1.0,
      movementBoundsScale: 1.7,
      soloMinTargetBodyLengths: 4.2,
      soloTargetVerticalBodyLengths: 0.42,
      soloSteeringTurnRateDegrees: 8,
      boundsYMin: -8,
      boundsZMin: -34,
      boundsZMax: 2,
    },
